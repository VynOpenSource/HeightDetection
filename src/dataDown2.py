...
download_url("https://vyn-opensource-ai-datasets.s3-eu-west-1.amazonaws.com/ai-height-detection/training-data/train_positive.zip","./data/data2/positive.zip")
print("Negative Data downloading...")
download_url("https://vyn-opensource-ai-datasets.s3-eu-west-1.amazonaws.com/ai-height-detection/training-data/train_negative.zip","./data/data2/negative.zip")
print("Done!")
